...
CREATE TABLE `stats` (
  ...
  `tonerno` varchar(100) DEFAULT NULL,
  `filled` int(11) DEFAULT NULL,
  `brandnew` int(11) DEFAULT NULL,
  `empty` int(11) DEFAULT NULL,
  `faulty` int(11) DEFAULT NULL,
  `drumno` varchar(50) DEFAULT NULL,
  `okstock` int(11) DEFAULT NULL,
  `notokstock` int(11) DEFAULT NULL,
...
-- Dump completed on 2018-06-27 12:01:57
